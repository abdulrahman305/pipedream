...
export default defineSource({
  ...
  description:
    "Emit new events when a new member was added. [See the docs](https://developers.buymeacoffee.com/#/apireference?id=members-v1subscriptions)",
  version: "0.0.3",
  type: "source",
  dedupe: "unique",
  methods: {
    ...
    compareFn(item: any): boolean {
      return (
        this.getLastCreatedTime() <
        new Date(item.subscription_created_on).getTime()
      );
    },
