...
export const ATTRIBUTE_OPTIONS = [
  {
    label: "Hot and New - popular businesses which recently joined Yelp",
    value: "hot_and_new",
  },
  {
    label:
  ...
  {
    label: "Deals - businesses offering Yelp Deals on their profile page",
    value: "deals",
  },
  {
    label:
  ...
  {
    label: "Open to All - businesses which are Open To All",
    value: "open_to_all",
  },
  {
    label: "Wheelchair Acessible - businesses which are Wheelchair Accessible",
