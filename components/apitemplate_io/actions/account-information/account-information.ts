...
export default defineAction({
  ...
  description:
    "Retrieves information about your account. [See the docs](https://apitemplate.io/apiv2/) for more information",
  ...
  async run({ $ }) {
    ...
    $.export(
      "$summary",
      `Successfully fetched your account information, status: ${response.status}`,
    );
    return response;
  },
});
