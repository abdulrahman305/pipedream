...
export default {
  ...
  props: {
    ...
    timezone: {
      ...
      label: "Timezone",
      description:
        "Timezone of the lead. View supported timezones from [here](https://app.mailbluster.com/pages/timezones).",
      optional: true,
    },
    ipAddress: {
      type: "string",
  ...
  async run({ $ }) {
    ...
    $.export(
      "$summary",
      `Lead ${data.firstName} ${data.lastName} was successfully created!`,
    );
    return response;
  },
};
