...
export default defineAction({
  ...
  props: {
    ...
    front: {
      ...
      label: "Front",
      description:
        "The artwork to use as the front of your postcard. May be a `templateId` or a HTML string. [HTML Examples](https://docs.lob.com/#section/HTML-Examples)",
    },
    back: {
      type: "string",
      label: "Back",
      description:
        "The artwork to use as the back of your postcard. May be a `templateId` or a HTML string. Be sure to leave room for address and postage information as in this [example template](https://s3-us-west-2.amazonaws.com/public.lob.com/assets/templates/postcards/4x6_postcard.pdf).",
    },
    size: {
      type: "string",
      label: "Size",
    ...
    mergeVariables: {
      ...
      description:
        "An object for substituting variables to render dynamic content in your template. [Merge Variables Guide](https://help.lob.com/en_US/print_mail/dynamic-personalization#using-html-and-merge-variables)",
      optional: true,
    },
    sendDate: {
      type: "string",
