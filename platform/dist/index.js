...
exports.$sendConfigRuntimeTypeChecker =
  exports.$send =
  exports.$end =
  exports.END_NEEDLE =
  exports.$event =
  exports.sendTypeMap =
  exports.SendConfigSSE =
  exports.SendConfigSnowflake =
  exports.SendConfigSQL =
  exports.SendConfigS3 =
  exports.SendConfigHTTP =
  exports.HTTP_METHODS =
  exports.SendConfigEmit =
  exports.SendConfigEmit_optional =
  exports.SendConfigEmit_required =
  exports.SendConfigEmail =
  exports.transformConfigForOauth =
  exports.axios =
    void 0;
const t = require("io-ts");
const axios_1 = require("./axios");
exports.axios = axios_1.default;
Object.defineProperty(exports, "transformConfigForOauth", {
  enumerable: true,
  get: function () {
    return axios_1.transformConfigForOauth;
  },
});
var utils_1 = require("./utils");
Object.defineProperty(exports, "cloneSafe", {
  enumerable: true,
  get: function () {
    return utils_1.cloneSafe;
  },
});
Object.defineProperty(exports, "jsonStringifySafe", {
  enumerable: true,
  get: function () {
    return utils_1.jsonStringifySafe;
  },
});
...
Object.defineProperty(exports, "ConfigurationError", {
  enumerable: true,
  get: function () {
    return errors_1.ConfigurationError;
  },
});
var sql_prop_1 = require("./sql-prop");
Object.defineProperty(exports, "sqlProp", {
  enumerable: true,
  get: function () {
    return sql_prop_1.default;
  },
});
var sql_proxy_1 = require("./sql-proxy");
Object.defineProperty(exports, "sqlProxy", {
  enumerable: true,
  get: function () {
    return sql_proxy_1.default;
  },
});
var constants_1 = require("./constants");
Object.defineProperty(exports, "DEFAULT_POLLING_SOURCE_TIMER_INTERVAL", {
  enumerable: true,
  get: function () {
    return constants_1.DEFAULT_POLLING_SOURCE_TIMER_INTERVAL;
  },
});
Object.defineProperty(exports, "PD_OFFICIAL_GMAIL_OAUTH_CLIENT_ID", {
  enumerable: true,
  get: function () {
    return constants_1.PD_OFFICIAL_GMAIL_OAUTH_CLIENT_ID;
  },
});
...
const SendConfigHTTPMethod = t.keyof(
  exports.HTTP_METHODS.reduce((acc, v) => {
    acc[v] = null;
    return acc;
  }, {}),
);
...
exports.$sendConfigRuntimeTypeChecker = (function () {
  const ret = {};
  for (const [sendName, sendConfigType] of Object.entries(
    exports.sendTypeMap,
  )) {
