...
from templates import (generate_actions, generate_apps,
                       generate_polling_sources, generate_webhook_sources)
...
def call_langchain(
    ...
    if not docs:
        return langchain_helpers.no_docs(
            prompt,
            templates,
            auth_details,
            parsed_common_files,
    ...
    if attempts >= max_attempts:
        ...
        return langchain_helpers.no_docs(
            prompt, templates, auth_details, urls_content, normal_order
        )
