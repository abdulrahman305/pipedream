...
const frontendHost =
  process.env.NEXT_PUBLIC_PIPEDREAM_FRONTEND_HOST || "pipedream.com";
    ...
    <main className="p-5 flex flex-col gap-2 max-w-5xl">
      {!appSlug && (
        <div className="flex flex-col gap-2 text-slate-800 pb-4">
          <div>
            <p>
              The <code>NEXT_PUBLIC_PIPEDREAM_APP_ID</code> variable is not set
              in your environment. Copy the <code>.env.example</code> file in
              this directory and fill in the appropriate environment variables.
            </p>
            <CodePanel
              language="plaintext"
        ...
        <div className="mb-48">
          ...
          <div className="mb-8">
            <p>
              ...
              for a full walkthrough of how to configure Connect for your site.
              This example app implements Connect in a Next.js (React) app.
            </p>
          </div>
          <div className="mb-8">
            <p>
              When your customers connect accounts with Pipedream, you&apos;ll
              pass their unique user ID in your system — whatever you use to
              identify them. In this example, we generate a random external user
              ID for you.
            </p>
          </div>
          <div className="mb-8">
          ...
          <div className="mb-8">
            <p>
              In <code>server.ts</code>, the app calls{" "}
              <code>serverConnectTokenCreate</code> to create a short-lived
              token for the user. You&apos;ll use that token to initiate app
              connection requests from your site securely. SEE THE DOCS.
            </p>
          </div>
          <div className="mb-8">
            <CodePanel
...
const { token, expires_at } = await serverConnectTokenCreate({
  ...
  external_user_id: "${externalUserId}",
          ...
          <p className="mb-8">
            When a user wants to connect an app from your frontend, you&apos;ll
            call <code>pd.connectAccount</code> with the token and the OAuth App
            ID of the app you&apos;d like to connect.
          </p>
          <div className="mb-8">
            <CodePanel
              language="typescript"
